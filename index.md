...
* 负责服务端的架构设计、基础模块开发：
  - 把现有的单服(gateway, game, db三进程架构)，扩展成针对大世界一服(gateway, global, logic, db)的架构，
    所有进程通过global组进行交互，logic根据功能划分为：user组, group组, social组, heartbeat, gm, scene manager等服务进程组。
  - 以global为基础，实现消息队列功能，隔离各个服务进程的通讯，负责路由通讯。
